...
<body class="min-h-screen flex flex-col tech-bg text-gray-100 relative">
    ...
    <main id="home"
        class="flex-1 flex items-center justify-center relative pt-24 lg:pt-20 overflow-hidden min-h-screen">
        ...
        <div class="absolute top-[15%] left-[8%] opacity-10 pointer-events-none z-0">
            <svg width="180" height="180" viewBox="0 0 24 24" fill="white" class="gear-spin">
                ...
                <path fill-rule="evenodd"
                    d="M20 12a8 8 0 11-16 0 8 8 0 0116 0zm-1.5 0a6.5 6.5 0 11-11-4.19v-.215c0-.552.448-1 1-1h.395c.552 0 1 .448 1 1v.215A6.477 6.477 0 0112 5.5c.552 0 1 .448 1 1v.395c0 .552.448 1 1 1h.215A6.477 6.477 0 0118.5 12z"
                    clip-rule="evenodd" />
                <path
                    d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v2h-2zm0 14h2v2h-2z" />
            </svg>
        </div>
        ...
        <!-- Central HUD Frame -->
        <div
            class="relative w-full max-w-6xl min-h-[600px] mx-4 lg:mx-12 flex flex-col lg:flex-row items-center justify-center z-10">

            <!-- Top White Line -->
            <div class="absolute top-0 left-4 lg:left-10 right-4 lg:right-10 h-px bg-white/80 shadow-[0_0_10px_white]">
            </div>
            <div class="absolute top-0 left-4 lg:left-10 w-24 lg:w-32 h-6 stripes transform -skew-x-12 origin-top-left">
            </div>

            <!-- Bottom White Line -->
            <div
                class="absolute bottom-0 left-4 lg:left-10 right-4 lg:right-10 h-px bg-white/80 shadow-[0_0_10px_white]">
            </div>
            <div
                class="absolute bottom-0 right-4 lg:right-10 w-24 lg:w-32 h-6 stripes-bottom transform -skew-x-12 origin-bottom-right">
            </div>
            ...
            <!-- Inner Content -->
            <div
                class="w-full h-full flex flex-col lg:flex-row items-center px-4 lg:px-16 relative py-12 lg:py-0 gap-8 lg:gap-16">

                <!-- Center vertical divider (Desktop only) -->
                <div
                    class="hidden lg:block absolute inset-y-0 left-1/2 transform -translate-x-1/2 pointer-events-none z-0">
                    <div class="w-px h-3/4 mx-auto bg-white/10"></div>
                </div>

                <!-- LEFT CONTENT -->
                <div
                    class="w-full lg:w-5/12 flex flex-col justify-center items-center lg:items-start text-center lg:text-left space-y-4 z-20 lg:pl-8 max-w-xl">
                    <h2
                        class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tighter leading-tight">
                    ...
                    <div class="pt-8">
                        ...
                        <?php else: ?>
                        <button onclick="document.getElementById('login-modal').scrollIntoView({ behavior: 'smooth' });"
                            class="bg-pink-500 hover:bg-pink-600 text-black font-bold text-lg px-10 py-4 rounded-full flex items-center gap-3 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-pink-500/50">
                            <span class="w-4 h-4 bg-black rounded-full"></span>
                            MAKE BOARD
                        </button>
                ...
                <div
                    class="w-full lg:w-7/12 h-80 lg:h-[500px] relative overflow-hidden carousel-mask flex items-center mt-8 lg:mt-0 lg:pr-8 z-10">
                    <div class="carousel-track flex-none">
                        <!-- Set 1 -->
                        <div class="flex gap-6 pr-6">
                            <div
                                class="w-40 lg:w-48 h-64 lg:h-80 bg-gray-800 border-r-4 border-gray-500 transform hover:scale-105 transition duration-300 relative flex items-center justify-center flex-shrink-0 group overflow-hidden">
                                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-90 bg-cover" style="background-image: url('https://www.riotgames.com/darkroom/1440/8d5c497da1c2eeec8cffa99b01abc64b:5329ca773963a5b739e98e715957ab39/ps-f2p-val-console-launch-16x9.jpg');">
                                </div>
                                <div class="absolute bottom-6 left-4 font-bold text-2xl tracking-wider z-10 text-glow">
                                    VALORANT</div>
                            </div>
                            <div
                                class="w-40 lg:w-48 h-64 lg:h-80 bg-gray-800 border-r-4 border-gray-500 transform hover:scale-105 transition duration-300 relative flex items-center justify-center flex-shrink-0 group overflow-hidden">
                                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-90 bg-cover"  style="background-image: url('https://upload.wikimedia.org/wikipedia/en/d/db/Apex_legends_cover.jpg');">
                                </div>
                                <div class="absolute bottom-6 left-4 font-bold text-2xl tracking-wider z-10 text-glow">
                                    APEX</div>
                            </div>
                            <div
                                class="w-40 lg:w-48 h-64 lg:h-80 bg-gray-800 border-r-4 border-gray-500 transform hover:scale-105 transition duration-300 relative flex items-center justify-center flex-shrink-0 group overflow-hidden">
                                <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-90 bg-cover" style="background-image: url('https://cdn2.unrealengine.com/fneco-2025-keyart-thumb-1920x1080-de84aedabf4d.jpg');">
                                </div>
                                <div class="absolute bottom-6 left-4 font-bold text-2xl tracking-wider z-10 text-glow">
                                    FORTNITE</div>
                            </div>
    ...
    <div class="w-full flex justify-center my-12">
        <div id="slider-card" class="group flex flex-col md:flex-row w-[90%] max-w-[900px] h-auto md:h-[450px] rounded-lg overflow-hidden 
            ...
            <div
                class="flex-1 p-8 md:p-[40px_50px] flex flex-col justify-center z-10 text-center md:text-left items-center md:items-start">
                <h1 id="slider-title"
                    class="text-3xl md:text-[2.2rem] font-extrabold mb-4 leading-tight tracking-tight text-[#111] transition-all duration-400 opacity-100 transform">
                    Our site features games released in all types of platforms
                </h1>
                <p id="slider-desc"
                    class="text-lg md:text-[1.1rem] leading-relaxed text-gray-700 max-w-[90%] transition-all duration-400 opacity-100 transform">
            ...
            <div class="flex-1 flex justify-center items-center p-5 relative">
                <img src="https://upload.wikimedia.org/wikipedia/en/c/c6/The_Legend_of_Zelda_Breath_of_the_Wild.jpg"
                    alt="Game Cover" id="slider-image" class="max-w-[320px] w-full h-auto rounded shadow-[0_15px_35px_rgba(0,0,0,0.6)]
    ...
    const images = [
        ...
        "https://e.snmc.io/lk/g/x/72f985e228a8cdf14a07809d91b8867e/9217773",
