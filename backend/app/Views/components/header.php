...
<body class="min-h-screen flex flex-col tech-bg text-gray-100 relative">
    ...
    <div class="fixed top-0 left-0 w-8 md:w-16 h-full bg-black z-30 tech-sidebar-left border-r border-gray-800 hidden md:block"></div>
    <div class="fixed top-0 right-0 w-8 md:w-16 h-full bg-black z-30 tech-sidebar-right border-l border-gray-800 hidden md:block"></div>

    <!-- Sticky Navigation -->
    <nav id="main-nav" class="fixed top-0 w-full flex items-center justify-between px-4 md:px-24 py-5 bg-black/90 backdrop-blur-md border-b border-gray-800 z-50 transition-all duration-300">
        ...
        <div class="flex items-center gap-6 md:gap-8">
            ...
            <div class="hidden lg:flex items-center gap-8">
                <a href="/#home" class="text-xl font-bold tracking-widest hover:text-white text-gray-300 transition">HOME</a>

                <!-- BOARDS Dropdown -->
                <div class="relative group h-full flex items-center cursor-pointer">
                    <div class="flex items-center gap-1 text-xl font-bold tracking-widest hover:text-white text-gray-300 transition py-2">
                        BOARDS
                    ...
                    <div class="dropdown-menu hidden absolute top-full left-0 mt-0 w-48 bg-gray-900 border border-gray-700 shadow-xl rounded-sm overflow-hidden">
                        <a href="#rpg" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">RPG Games</a>
                        <a href="#fps" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">FPS Shooters</a>
                        <a href="#strategy" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">Strategy</a>
                    </div>
                </div>
                ...
                <div class="relative group h-full flex items-center cursor-pointer">
                    ...
                    <div class="dropdown-menu hidden absolute top-full left-0 mt-0 w-48 bg-gray-900 border border-gray-700 shadow-xl rounded-sm overflow-hidden">
                        <a href="#settings" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">Settings</a>
                        <a href="#profile" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">Profile</a>
                        <a href="#about" class="block px-4 py-3 text-sm text-gray-300 hover:bg-blue-900/50 hover:text-white transition">About Us</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- RIGHT SECTION: Login -->
        <a href="<?= base_url('login') ?>" class="flex items-center gap-2 cursor-pointer hover:text-white text-gray-300 transition group">
    ...
    <div id="mobile-menu" class="fixed inset-y-0 left-0 w-72 bg-black/95 border-r border-gray-800 z-40 menu-closed pt-20 px-0 lg:hidden shadow-2xl flex flex-col overflow-y-auto">
        ...
        <div class="flex flex-col">
            ...
            <a href="#home" class="px-6 py-4 text-xl font-bold tracking-widest text-gray-300 hover:text-white hover:bg-gray-900 transition-colors border-l-4 border-transparent hover:border-blue-500">
                HOME
            </a>
            ...
            <div class="border-b border-gray-800/50">
                <button onclick="toggleMobileSubmenu('mobile-boards-submenu', 'boards-arrow')" aria-expanded="false" class="w-full px-6 py-4 flex items-center justify-between text-xl font-bold tracking-widest text-gray-300 hover:text-white hover:bg-gray-900 transition-colors group">
                    BOARDS
                    <svg id="boards-arrow" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform duration-300 text-gray-500 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <!-- Submenu Container -->
                <div id="mobile-boards-submenu" class="mobile-submenu bg-gray-900/30">
                    <div class="flex flex-col py-2">
                        <a href="#rpg" class="pl-12 pr-6 py-3 text-gray-400 hover:text-blue-400 hover:bg-black/20 transition-colors flex items-center gap-2 text-lg">
                            <div class="w-1 h-1 bg-blue-500 rounded-full"></div> RPG Games
                        </a>
                        <a href="#fps" class="pl-12 pr-6 py-3 text-gray-400 hover:text-blue-400 hover:bg-black/20 transition-colors flex items-center gap-2 text-lg">
                            <div class="w-1 h-1 bg-blue-500 rounded-full"></div> FPS Shooters
                        </a>
                        <a href="#strategy" class="pl-12 pr-6 py-3 text-gray-400 hover:text-blue-400 hover:bg-black/20 transition-colors flex items-center gap-2 text-lg">
            ...
            <div class="border-b border-gray-800/50">
                <button onclick="toggleMobileSubmenu('mobile-more-submenu', 'more-arrow')" aria-expanded="false" class="w-full px-6 py-4 flex items-center justify-between text-xl font-bold tracking-widest text-gray-300 hover:text-white hover:bg-gray-900 transition-colors group">
                    MORE
                    <svg id="more-arrow" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform duration-300 text-gray-500 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <!-- Submenu Container -->
    ...
    <div id="menu-overlay" class="fixed inset-0 bg-black/50 z-30 hidden lg:hidden backdrop-blur-sm" onclick="toggleMenu()"></div>
